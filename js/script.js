const RADIO_NAME = 'MQL Radio';

// Change Stream URL Here, Supports, ICECAST, ZENO, SHOUTCAST, RADIOJAR and any other stream service.
const URL_STREAMING = 'https://stream.zeno.fm/v5ymqvtagv8uv';
...
// the API link will be 'https://api.zeno.fm/mounts/metadata/subscribe/v5ymqvtagv8uv'.

const url = 'https://api.zeno.fm/mounts/metadata/subscribe/v5ymqvtagv8uv';
